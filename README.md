...
This repository contains the b ackend for a news api project, allowing access to articles, comments, users and topics.
...
Developer dependencies for installation:
Dependency 	Version
Express 	4.17.1
Knex 	0.20.2
...
Firstly, click the clone or download button and copy the path.
...
Once cloned, open in a code editor such as Visual Studio:
...
$ git clone https://github.com/meke101/news-api-projec
